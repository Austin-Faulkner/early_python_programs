...
#  Date Last Modified: September 29, 2019
...
def main():
    ...
    if guessedNumber == SECRET_NUMBER and guesses == 1:
    ...
    while guesses <= 10:
            ...
            if guessedNumber > SECRET_NUMBER:
                ...
                while guessedNumber <= 0 or guessedNumber >= 10000:
                    ...
                    # While the player guesses the correct number (after incorrect input),
                    # send congratulations and indicate which guess number, between
                    # 2 and 10, the player guessed correctly on.
                    while guessedNumber == SECRET_NUMBER and guesses != 1: 
                        print("That's correct!")
            ...
            elif guessedNumber == SECRET_NUMBER and guesses != 1: 
                print("That's correct!")
                print("Congratulations! You guessed it in " + str(guesses) + " guesses.")
                break
